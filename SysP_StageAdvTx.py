...
class StageAdvTx:
    ...
    def Process(self, entity):
        ...
        if entity.Scenario_Chemo == 1 and entity.tx_prim == 'Other':
            if probChemo < self.prob_other_chemo:
                scenario = 1
                int_adj = entity.RR_Chemo
        ...
        if entity.tx_prim == 'Surgery':
            ...
            if probChemo < self.prob_other_chemo:
                entity.chemoCount += 1
                entity.hadChemo = 1
                if entity.Scenario_Chemo == 1 and scenario == 1:
                    entity.resources.append(('Experimental Chemo', entity.allTime))
                    entity.scenario_desc.append(('Experimental Chemo'))
